...
namespace LeagueOfMonads.NoLambda
{
   public static class OptionExt
   {
      ...
      public static Option<TResult> Map<T, A, TResult>(this Option<T> m, Func<T, A, Option<TResult>> f, A a)
      {
         return m.Map(t => f(t, a));
      }


      public static Option<TResult> Map<T, A, B, TResult>(this Option<T> m, Func<T, A, B, Option<TResult>> f, A a, B b)
      {
         return m.Map(t => f(t, a, b));
      }


      public static Option<TResult> Map<T, A, B, C, TResult>(this Option<T> m, Func<T, A, B, C, Option<TResult>> f, A a, B b, C c)
      {
         return m.Map(t => f(t, a, b, c));
      }
      ...
      public static Task<Option<TResult>> Map<T, A, TResult>(this Option<T> m, Func<T, A, Task<Option<TResult>>> f, A a)
      {
         return m.Map(t => f(t, a));
      }


      public static Task<Option<TResult>> Map<T, A, B, TResult>(this Option<T> m, Func<T, A, B, Task<Option<TResult>>> f, A a, B b)
      {
         return m.Map(t => f(t, a, b));
      }


      public static Task<Option<TResult>> Map<T, A, B, C, TResult>(this Option<T> m, Func<T, A, B, C, Task<Option<TResult>>> f, A a, B b, C c)
      {
         return m.Map(t => f(t, a, b, c));
      }
      ...
      public static async Task<Option<TResult>> Map<T, A, TResult>(this Task<Option<T>> m, Func<T, A, Option<TResult>> f, A a)
      {
         return (await m).Map(t => f(t, a));
      }


      public static async Task<Option<TResult>> Map<T, A, B, TResult>(this Task<Option<T>> m, Func<T, A, B, Option<TResult>> f, A a, B b)
      {
         return (await m).Map(t => f(t, a, b));
      }


      public static async Task<Option<TResult>> Map<T, A, B, C, TResult>(this Task<Option<T>> m, Func<T, A, B, C, Option<TResult>> f, A a, B b, C c)
      {
         return (await m).Map(t => f(t, a, b, c));
      }
      ...
      public static async Task<Option<TResult>> Map<T, A, TResult>(this Task<Option<T>> m, Func<T, A, Task<Option<TResult>>> f, A a)
      {
         return await (await m).Map(async t => await f(t, a));
      }


      public static async Task<Option<TResult>> Map<T, A, B, TResult>(this Task<Option<T>> m, Func<T, A, B, Task<Option<TResult>>> f, A a, B b)
      {
         return await (await m).Map(async t => await f(t, a, b));
      }


      public static async Task<Option<TResult>> Map<T, A, B, C, TResult>(this Task<Option<T>> m, Func<T, A, B, C, Task<Option<TResult>>> f, A a, B b, C c)
      {
         return await (await m).Map(async t => await f(t, a, b, c));
      }
